...
from newsletter.tasks import daily_tasks, weekly_tasks, monthly_tasks
...
def send_newsletter_after_creation(sender, instance, created, **kwargs):
    if created:
        send_newsletter(instance)

# Подключение обработчика сигнала
post_save.connect(send_newsletter_after_creation, sender=Newsletter)